...
// #define BLINKER_ESP_SMARTCONFIG				// 一键配网功能,如果需要就打开
#define BLINKER_WIFI						// 启用WiFi连接
char ssid[] = "OnePlus11"; //你的 WIFI 名称
char pswd[] = "9876543210"; //你的 WIFI 密码
...
#define FUNCTION_ASR 1			// 语音识别功能开关（0关闭）
...
#define FANON_LEN (sizeof(FANon) / sizeof(FANon[0]))
...
uint16_t FANon[95] = {1296, 384,  1296, 384,  454, 1226,  1296, 386,  1296, 384,  454, 1226, 
 454, 1226,  454, 1226,  454, 1226,  454, 1226,  452, 1226,  1294, 7230,  1294, 384,  1294, 386,  454, 1224,  1294, 386,  1294, 384,  454, 1224,  452, 1226,  454, 1224,  452, 1226,  452, 1226,  454, 1226,  1294, 7230,  1292, 386,  1294, 386,  454, 1226,  1294, 384,  1294, 386,  454, 1224,  454, 1226,  452, 1226,  456, 1224,  454, 1226,  452, 1226,  1294, 7230,  1294, 386,  1294, 386,  452, 1224,  1294, 386,  1294, 384,  454, 1224,  454, 1224,  454, 1222,  454, 1224,  452, 1224,  454, 1224,  1294};
...
BlinkerButton Button5("btn-fir");			 // 风扇开关
char auth[] = "0c5c2a639c66"; // 设备密钥，用于连接点灯Blinker APP
...
{
	Button2.print("空调开");
	irsend.sendRaw(ACon, ACON_LEN, khz); // 发送原始红外信号										   // 延时2秒，确保信号发送完成
}
// 空调关
void button3_callback(const String &state)
{
	Button3.print("空调关");
	irsend.sendRaw(ACoff, ACOFF_LEN, khz);
}
// 电视开关
void button4_callback(const String &state)
{
	// 发送电视开机信号
	irsend.sendRaw(TVon, TVON_LEN, khz);
	Button4.print("电视开关");
}
// 风扇开关
void button5_callback(const String &state)
{
	...
	Button5.print("风扇开关");
	sendIRSignal(FANon, FANON_LEN, khz);
}
